    ...
    <Div id="component-grid">
      <NotificationsWrapper position="right" anchor="top">
        <NotificationItem
          ...
          isDismissible
        >
          <Text>I am here to notify you that...um, wait, I forgot.</Text>
        </NotificationItem>
      </NotificationsWrapper>
      ;
              ...
              <Card shape="rounded" className="component-wrapper" isFullHeight>
                <Div className="component-card">
                  ...
                  <Element as="footer" className="footer-bottom">
                    <Link href="/components/button">Button &rarr;</Link>
                  </Element>
                </Div>
              </Card>
            </Div>
            ...
            <Div id="type-card" className="grid-item">
              <Card shape="rounded" className="component-wrapper" isFullHeight>
                <Div className="component-card">
                  ...
                  <Element as="footer" className="footer-bottom">
                    <Link href="/components/typography">Typography &rarr;</Link>
                  </Element>
                </Div>
              </Card>
            </Div>
            ...
            <Div id="progress-card" className="grid-item">
              <Card shape="rounded" className="component-wrapper" isFullHeight>
                <Div className="component-card">
                  ...
                  <Element as="footer" className="footer-bottom">
                    <Link href="/components/button">Progress bar &rarr;</Link>
                  </Element>
                </Div>
              </Card>
            </Div>
            ...
            <Div id="input-card" className="grid-item">
              <Card shape="rounded" className="component-wrapper" isFullHeight>
                <Div className="component-card">
                  ...
                  <Element as="footer" className="footer-bottom">
                    <Link href="/components/button">Input field &rarr;</Link>
                  </Element>
                </Div>
              </Card>
            </Div>
