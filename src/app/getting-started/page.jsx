...
const GettingStarted = () => {
  ...
  return (
    <article id="page-getting-started">
        ...
        <Row horizontalPadding="huge">
          ...
          <Portion>
            ...
            <Text marginBottom="micro">
              ...
              <a
                href="https://fictoan.io/boilerplate"
                target="_blank"
                rel="noreferrer"
              >
                Fictoan boilerplate &#8599;
              </a>
              . It’s a simple, bare-bones NextJS app with Fictoan already
      ...
      <Divider kind="primary" horizontalMargin="huge" verticalMargin="micro" />
      ...
      <Element as="section" id="patterns">
        ...
        >
          <Portion>
            <Heading6 weight="700" size="large" marginBottom="nano">
              Importing
            </Heading6>

            <Text marginBottom="micro">
              Import the main CSS file in your app entry point. This will make
              sure that the Fictoan styles are available to all components.
            </Text>
            ...
            <Text marginBottom="micro">
              In your content files, just import the components you need at the
              top, and use them inside the return function like so—
            </Text>
          ...
          <Portion>
            ...
            <Text marginBottom="micro">
              Fictoan components are just simple wrappers around HTML elements.
              You can extend their look and feel by passing props to them.
            </Text>

            <Text marginBottom="micro">
              For example, a <code>Card</code> component has props such as{" "}
              <code>shape</code>, <code>shadow</code> and <code>padding</code>.
              Similarly, a <code>Table</code> has <code>bordersFor</code>,{" "}
              <code>isStriped</code> and so on. You don’t have to remember
              complex terminology, and Fictoan tries to be as intuitive as
              possible.
            </Text>

            <Text marginBottom="micro">
              Here’s an interactive example. Here we have a default{" "}
              <code>Card</code> component. It looks like just a line because all
              you’re seeing is the border. Start by adding some padding to it.
            </Text>
          </Portion>
        </Row>
        ...
        <Row horizontalPadding="huge">
          <Portion>
            <Text marginBottom="micro">
              It’s that easy. The markup is clean, easy to understand, and no
              complex nomenclature or cryptic notation to remember.
            </Text>

            <Text>
              The global default values for the background colour, border colour
              and width, and the border-radius value are set via the theme file.
              You can change them by creating your own theme file and
              over-riding the values.{" "}
              <Link href="/theme">Read more about theming here</Link>.
            </Text>
          </Portion>
        </Row>
        ...
        <Row id="attributes" horizontalPadding="huge">
          <Portion>
            ...
            <Text marginBottom="micro">
              Keeping in line with the reduced terminology to remember, most
              elements and components have the same list of values for their
              props.
            </Text>

            <Text marginBottom="micro">
              Since a vast majority of UI design revolves around relationships
              and position between elements, it makes sense to have a finite
              list of default values to manage these aspects.
            </Text>

            <Text marginBottom="micro">
              The list of props on the left all take values from the right. Some
              props of certain elements don’t accept <code>nano</code> and{" "}
              <code>micro</code>, as their values would be too small to discern
              on the screen.
            </Text>
          </Portion>
          ...
          <Portion>
            <Row marginBottom="none" retainLayoutAlways>
              <Portion desktopSpan="half">
                <Text weight="700" size="large" marginBottom="none">
                  Prop
                </Text>
          ...
          <Portion>
            ...
            <Text marginBottom="micro">
              Another thing to keep in mind is that they are also contextual.
              For example, <code>padding="small"</code> might mean different
              things to a <code>Card</code> component and a <code>Table</code>{" "}
              component. While this seems counter-intuitive, it takes into
              account the possible real-world use cases. It is unlikely you’d
              need a <code>Table</code> cell with <code>4vh</code> of padding,
              right?
            </Text>
          </Portion>
        </Row>
