...
import { Card } from "fictoan-react/dist";
        ...
        <ColourStyled>
            ...
            <Element as="section" id="basics">
                <Row sidePadding="huge" marginBottom="micro">
                    <Portion>
                        <Heading as="h4">Adding colour</Heading>
                    </Portion>

                    <Portion>
                        <Text>
                            FICTOAN comes with 223 different variables for adding colour to your elements. There are five props&mdash;<code>bgColour</code>, <code>textColour</code>, <code>borderColour</code>, <code>strokeColour</code> and <code>fillColour</code>&mdash;that accept any value from the colour list below. Use them like so&mdash;
                        </Text>

                        <CodeBlock source={ sampleColourUsage } language="jsx" />

                        <Text>
                            The last two props&mdash;<code>strokeColour</code> and <code>fillColour</code>&mdash;work only for SVG elements.
                        </Text>

                        <Text>And oh, you can use both spellings of “colour”—<code>bgColour</code> or <code>bgColor</code> as props. This applies for all five props above.</Text>
                    </Portion>
                </Row>
            </Element>
            ...
            <Element as="section" id="colour-list">
                <Row sidePadding="huge" marginBottom="micro">
                    <Portion>
                        <Heading as="h4">List of colours</Heading>
                ...
                <Row sidePadding="tiny" gutters="none">
                    ...
                    <Portion desktopSpan="2" tabLSSpan="4" tabPTSpan="8">
                        ...
                        <Text margin="none" size="small">black</Text>
                    </Portion>

                    <Portion desktopSpan="2" tabLSSpan="4" tabPTSpan="8">
                        <Card padding="tiny" bgColor="white" />
                        <Text margin="none" size="small">white</Text>
                    </Portion>

                    <Portion desktopSpan="2" tabLSSpan="4" tabPTSpan="8">
                        <Card padding="tiny" bgColor="transparent" borderColor="transparent" id="transparent-card" />
                        <Text margin="none" size="small">transparent</Text>
                    </Portion>
